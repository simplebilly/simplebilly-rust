...
pub struct KostenVorschau {
    #[serde(rename = "eintraege")]
    pub eintraege: Vec<models::KostenEintrag>,
    #[serde(rename = "gesamt")]
    pub gesamt: String,
}

impl KostenVorschau {
    pub fn new(eintraege: Vec<models::KostenEintrag>, gesamt: String) -> KostenVorschau {
        KostenVorschau {
            eintraege,
            gesamt,
        }
