...
pub struct PluginErrorOneOf3 {
    #[serde(rename = "InternalError")]
    pub internal_error: Vec<serde_json::Value>,
}

impl PluginErrorOneOf3 {
    pub fn new(internal_error: Vec<serde_json::Value>) -> PluginErrorOneOf3 {
        PluginErrorOneOf3 {
            internal_error,
        }
    }
