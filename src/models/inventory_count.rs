...
impl InventoryCount {
    pub fn new(count_date: chrono::NaiveDate, count_number: String, line_items: Option<serde_json::Value>, status: models::InventoryCountStatus, warehouse_id: String) -> InventoryCount {
        InventoryCount {
            count_date,
            count_number,
            line_items,
