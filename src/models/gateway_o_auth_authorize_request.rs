...
pub struct GatewayOAuthAuthorizeRequest {
...
impl GatewayOAuthAuthorizeRequest {
    pub fn new(gateway_type: String, redirect_uri: String) -> GatewayOAuthAuthorizeRequest {
