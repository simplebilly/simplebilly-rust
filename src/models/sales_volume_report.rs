...
pub struct SalesVolumeReport {
    #[serde(rename = "grand_total")]
    pub grand_total: String,
    #[serde(rename = "items")]
    pub items: Vec<models::SalesVolumeItem>,
    #[serde(rename = "total_count")]
    pub total_count: i64,
}

impl SalesVolumeReport {
    pub fn new(grand_total: String, items: Vec<models::SalesVolumeItem>, total_count: i64) -> SalesVolumeReport {
        SalesVolumeReport {
            grand_total,
            items,
            total_count,
