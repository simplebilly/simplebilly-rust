...
pub struct PriceTierUpdate {
    ...
    #[serde(rename = "minQuantity", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub min_quantity: Option<Option<i64>>,
...
impl PriceTierUpdate {
    pub fn new(unit_price: String) -> PriceTierUpdate {
        PriceTierUpdate {
