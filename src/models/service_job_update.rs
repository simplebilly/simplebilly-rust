...
pub struct ServiceJobUpdate {
    ...
    #[serde(rename = "estimatedDurationMinutes", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub status: Option<Option<models::ServiceJobStatus>>,
}

impl ServiceJobUpdate {
    pub fn new() -> ServiceJobUpdate {
        ServiceJobUpdate {
            address: None,
            customer_email: None,
            customer_id: None,
