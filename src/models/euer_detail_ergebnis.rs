...
pub struct EuerDetailErgebnis {
    #[serde(rename = "jahr")]
    pub jahr: i32,
    #[serde(rename = "zeilen")]
    pub zeilen: Vec<models::EuerZeileDetail>,
}

impl EuerDetailErgebnis {
    pub fn new(jahr: i32, zeilen: Vec<models::EuerZeileDetail>) -> EuerDetailErgebnis {
        EuerDetailErgebnis {
            jahr,
            zeilen,
        }
