...
pub struct AbsenceUpdate {
    ...
    #[serde(rename = "absenceType", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub absence_type: Option<Option<models::AbsenceType>>,
    ...
    pub status: Option<Option<models::AbsenceStatus>>,
}

impl AbsenceUpdate {
    pub fn new() -> AbsenceUpdate {
        AbsenceUpdate {
            absence_type: None,
            approved_at: None,
            approved_by: None,
