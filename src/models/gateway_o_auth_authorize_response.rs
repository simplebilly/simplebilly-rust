...
pub struct GatewayOAuthAuthorizeResponse {
...
impl GatewayOAuthAuthorizeResponse {
    pub fn new(authorization_url: String, state: String) -> GatewayOAuthAuthorizeResponse {
