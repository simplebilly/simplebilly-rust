...
pub struct UpdateSyncDirectionRequest {
    #[serde(rename = "directions")]
    pub directions: std::collections::HashMap<String, String>,
}

impl UpdateSyncDirectionRequest {
    pub fn new(directions: std::collections::HashMap<String, String>) -> UpdateSyncDirectionRequest {
