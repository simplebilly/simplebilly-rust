...
pub struct ApiResponseVecUserTenantInfo {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::ApiResponseVecUserTenantInfoDataInner>>,
...
impl ApiResponseVecUserTenantInfo {
    pub fn new(success: bool) -> ApiResponseVecUserTenantInfo {
