...
pub struct SupportChannel {
    ...
    pub channel_type: models::SupportChannelType,
...
impl SupportChannel {
    pub fn new(channel_type: models::SupportChannelType, config: Option<serde_json::Value>, created_at: chrono::DateTime<chrono::FixedOffset>, is_active: bool, name: String, tenant_id: uuid::Uuid) -> SupportChannel {
        SupportChannel {
            channel_type,
            config,
            created_at,
