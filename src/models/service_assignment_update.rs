...
pub struct ServiceAssignmentUpdate {
    ...
    pub scheduled_date: Option<Option<chrono::NaiveDate>>,
    ...
    pub status: Option<Option<models::ServiceAssignmentStatus>>,
}

impl ServiceAssignmentUpdate {
    pub fn new() -> ServiceAssignmentUpdate {
