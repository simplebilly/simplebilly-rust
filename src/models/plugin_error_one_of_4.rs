...
pub struct PluginErrorOneOf4 {
    #[serde(rename = "DatabaseError")]
    pub database_error: Vec<serde_json::Value>,
}

impl PluginErrorOneOf4 {
    pub fn new(database_error: Vec<serde_json::Value>) -> PluginErrorOneOf4 {
        PluginErrorOneOf4 {
            database_error,
        }
    }
