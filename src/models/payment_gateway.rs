...
impl PaymentGateway {
    pub fn new(config: Option<serde_json::Value>, created_at: chrono::DateTime<chrono::FixedOffset>, enabled: bool, gateway_id: String, gateway_type: models::GatewayType, label: String, tenant_id: uuid::Uuid) -> PaymentGateway {
        PaymentGateway {
            config,
            created_at,
            deleted_at: None,
