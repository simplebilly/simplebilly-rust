...
pub struct Quotation {
    ...
    pub expiration_date: Option<Option<chrono::NaiveDate>>,
    ...
    #[serde(rename = "quotationNumber", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl Quotation {
    pub fn new(currency: String, voucher_date: chrono::NaiveDate, voucher_status: models::VoucherStatus) -> Quotation {
        Quotation {
            address: None,
            contact_id: None,
            contact_name: None,
