...
pub struct DatevExportResponse {
    #[serde(rename = "booking_count")]
    pub booking_count: i32,
    #[serde(rename = "csv_content")]
    pub csv_content: String,
    #[serde(rename = "filename")]
    pub filename: String,
}

impl DatevExportResponse {
    pub fn new(booking_count: i32, csv_content: String, filename: String) -> DatevExportResponse {
        DatevExportResponse {
            booking_count,
            csv_content,
            filename,
