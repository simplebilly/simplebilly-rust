...
pub struct ShareholderUpdate {
    ...
    #[serde(rename = "shares", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub shares: Option<Option<String>>,
}

impl ShareholderUpdate {
    pub fn new() -> ShareholderUpdate {
        ShareholderUpdate {
            address: None,
            birth_date: None,
            email: None,
