...
pub struct SendMessageDto {
    #[serde(rename = "body")]
    pub body: String,
    #[serde(rename = "is_internal", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub is_internal: Option<Option<bool>>,
}

impl SendMessageDto {
    pub fn new(body: String) -> SendMessageDto {
        SendMessageDto {
            body,
            is_internal: None,
        }
