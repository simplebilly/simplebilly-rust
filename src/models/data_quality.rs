...
pub struct DataQuality {
    #[serde(rename = "activity_lines")]
    pub activity_lines: i32,
    #[serde(rename = "activity_share_pct")]
    pub activity_share_pct: f64,
    #[serde(rename = "spend_lines")]
    pub spend_lines: i32,
}

impl DataQuality {
    pub fn new(activity_lines: i32, activity_share_pct: f64, spend_lines: i32) -> DataQuality {
        DataQuality {
            activity_lines,
            activity_share_pct,
            spend_lines,
