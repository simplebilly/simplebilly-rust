...
pub struct DeliveryAppointment {
    #[serde(rename = "email")]
    pub email: String,
...
impl DeliveryAppointment {
    pub fn new(email: String, requested_date: chrono::NaiveDate, status: models::DeliveryAppointmentStatus, supplier_name: String, warehouse_id: String) -> DeliveryAppointment {
        DeliveryAppointment {
            email,
            notes: None,
            phone: None,
