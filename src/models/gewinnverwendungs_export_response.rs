...
pub struct GewinnverwendungsExportResponse {
...
impl GewinnverwendungsExportResponse {
    pub fn new(csv_content: String, filename: String) -> GewinnverwendungsExportResponse {
