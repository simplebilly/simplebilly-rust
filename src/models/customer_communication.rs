...
pub struct CustomerCommunication {
...
impl CustomerCommunication {
    pub fn new(channel: models::CommunicationChannel, contact_id: String, direction: models::CommunicationDirection) -> CustomerCommunication {
