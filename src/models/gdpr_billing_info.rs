...
pub struct GdprBillingInfo {
    ...
    #[serde(rename = "currentPeriodStart", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub current_period_start: Option<Option<chrono::DateTime<chrono::FixedOffset>>>,
...
impl GdprBillingInfo {
    pub fn new(tenant_id: uuid::Uuid) -> GdprBillingInfo {
        GdprBillingInfo {
