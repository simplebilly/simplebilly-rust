...
impl UserProfile {
    pub fn new(created_at: chrono::DateTime<chrono::FixedOffset>, email: String, email_verified: bool, first_name: String, full_name: String, id: uuid::Uuid, last_name: String) -> UserProfile {
        UserProfile {
            created_at,
            email,
            email_verified,
