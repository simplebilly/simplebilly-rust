...
pub struct DeliveryDateCreate {
    ...
    pub promised_date: chrono::NaiveDate,
    /// One of: promised | confirmed | rescheduled | fulfilled | late | cancelled
    #[serde(rename = "status", deserialize_with = "Option::deserialize")]
    pub status: Option<models::DeliveryDateStatus>,
}

impl DeliveryDateCreate {
    pub fn new(order_number: String, promised_date: chrono::NaiveDate, status: Option<models::DeliveryDateStatus>) -> DeliveryDateCreate {
        DeliveryDateCreate {
            customer_id: None,
            fulfilled_date: None,
            note: None,
