...
impl GdprRefreshToken {
    pub fn new(created_at: chrono::DateTime<chrono::FixedOffset>, expires_at: chrono::DateTime<chrono::FixedOffset>, id: uuid::Uuid, tenant_id: uuid::Uuid) -> GdprRefreshToken {
        GdprRefreshToken {
            created_at,
            expires_at,
            id,
