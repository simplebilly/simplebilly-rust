...
pub struct EmployeeUpdate {
    ...
    #[serde(rename = "departmentId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub status: Option<Option<models::EmployeeStatus>>,
