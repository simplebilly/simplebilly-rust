...
impl Team {
    pub fn new(created_at: chrono::DateTime<chrono::FixedOffset>, id: uuid::Uuid, name: String, tenant_id: uuid::Uuid, updated_at: chrono::DateTime<chrono::FixedOffset>) -> Team {
        Team {
            created_at,
            description: None,
            id,
