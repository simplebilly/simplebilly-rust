...
pub struct Attachment {
    ...
    #[serde(rename = "ocrText", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl Attachment {
    pub fn new(file_name: String, original_name: String) -> Attachment {
        Attachment {
            contact_id: None,
            file_name,
            file_size: None,
