...
pub struct PublicReturnRequest {
    #[serde(rename = "email")]
    pub email: String,
    #[serde(rename = "items")]
    pub items: Vec<models::PublicReturnItem>,
...
impl PublicReturnRequest {
    pub fn new(email: String, items: Vec<models::PublicReturnItem>, order_number: String) -> PublicReturnRequest {
        PublicReturnRequest {
            email,
            items,
            notes: None,
