...
pub struct AiSuggestionRequest {
    ...
    #[serde(rename = "message_body", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub message_body: Option<Option<String>>,
    #[serde(rename = "ticket_id")]
    pub ticket_id: uuid::Uuid,
}

impl AiSuggestionRequest {
    pub fn new(ticket_id: uuid::Uuid) -> AiSuggestionRequest {
        AiSuggestionRequest {
            instructions: None,
            message_body: None,
            ticket_id,
