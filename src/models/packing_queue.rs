...
pub struct PackingQueue {
    #[serde(rename = "items")]
    pub items: Vec<models::PackingQueueItem>,
    #[serde(rename = "page")]
    pub page: i32,
...
impl PackingQueue {
    pub fn new(items: Vec<models::PackingQueueItem>, page: i32, page_size: i32, total_count: i64) -> PackingQueue {
        PackingQueue {
            items,
            page,
            page_size,
