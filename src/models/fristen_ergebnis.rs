...
pub struct FristenErgebnis {
    #[serde(rename = "anzahl")]
    pub anzahl: i32,
    #[serde(rename = "fristen")]
    pub fristen: Vec<models::FristEintrag>,
}

impl FristenErgebnis {
    pub fn new(anzahl: i32, fristen: Vec<models::FristEintrag>) -> FristenErgebnis {
        FristenErgebnis {
            anzahl,
            fristen,
        }
