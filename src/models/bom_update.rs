...
pub struct BomUpdate {
    ...
    #[serde(rename = "outputQuantity", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub output_quantity: Option<Option<i64>>,
    ...
    pub status: Option<Option<models::BomStatus>>,
}

impl BomUpdate {
    pub fn new() -> BomUpdate {
        BomUpdate {
            components: None,
            description: None,
            name: None,
