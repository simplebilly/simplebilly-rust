...
pub struct TimeEntryClockOut {
    #[serde(rename = "clock_out")]
    pub clock_out: chrono::DateTime<chrono::FixedOffset>,
...
impl TimeEntryClockOut {
    pub fn new(clock_out: chrono::DateTime<chrono::FixedOffset>) -> TimeEntryClockOut {
        TimeEntryClockOut {
            clock_out,
            hours: None,
        }
