...
pub struct PluginErrorOneOf5 {
    #[serde(rename = "ValidationError")]
    pub validation_error: Vec<serde_json::Value>,
}

impl PluginErrorOneOf5 {
    pub fn new(validation_error: Vec<serde_json::Value>) -> PluginErrorOneOf5 {
        PluginErrorOneOf5 {
            validation_error,
        }
    }
