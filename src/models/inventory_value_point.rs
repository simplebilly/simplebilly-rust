...
impl InventoryValuePoint {
    pub fn new(product_count: i64, recorded_at: chrono::DateTime<chrono::FixedOffset>, total_purchase_value: String, total_sales_value: String) -> InventoryValuePoint {
        InventoryValuePoint {
            product_count,
            recorded_at,
