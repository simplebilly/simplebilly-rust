...
pub struct PublicReturnResponse {
...
impl PublicReturnResponse {
    pub fn new(created_at: chrono::DateTime<chrono::FixedOffset>, items: Option<serde_json::Value>, return_number: String, return_order_id: String, status: String) -> PublicReturnResponse {
