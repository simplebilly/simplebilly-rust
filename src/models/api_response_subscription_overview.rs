...
pub struct ApiResponseSubscriptionOverview {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ApiResponseSubscriptionOverviewData>>,
...
impl ApiResponseSubscriptionOverview {
    pub fn new(success: bool) -> ApiResponseSubscriptionOverview {
