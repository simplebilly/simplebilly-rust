...
pub struct ApiResponseGdprExport {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ApiResponseGdprExportData>>,
...
impl ApiResponseGdprExport {
    pub fn new(success: bool) -> ApiResponseGdprExport {
