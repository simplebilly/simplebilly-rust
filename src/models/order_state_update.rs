...
pub struct OrderStateUpdate {
    #[serde(rename = "send_state_to_shop", skip_serializing_if = "Option::is_none")]
    pub send_state_to_shop: Option<bool>,
    #[serde(rename = "state")]
    pub state: String,
}

impl OrderStateUpdate {
    pub fn new(state: String) -> OrderStateUpdate {
        OrderStateUpdate {
            send_state_to_shop: None,
            state,
        }
    }
}
