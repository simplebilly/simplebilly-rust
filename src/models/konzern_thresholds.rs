...
pub struct KonzernThresholds {
    #[serde(rename = "bilanzsumme")]
    pub bilanzsumme: String,
    #[serde(rename = "mitarbeiter")]
    pub mitarbeiter: i64,
    #[serde(rename = "netto_umsatz")]
    pub netto_umsatz: String,
}

impl KonzernThresholds {
    pub fn new(bilanzsumme: String, mitarbeiter: i64, netto_umsatz: String) -> KonzernThresholds {
        KonzernThresholds {
            bilanzsumme,
            mitarbeiter,
            netto_umsatz,
