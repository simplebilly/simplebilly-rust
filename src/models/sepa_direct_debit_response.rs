...
pub struct SepaDirectDebitResponse {
...
impl SepaDirectDebitResponse {
    pub fn new(content_type: String, filename: String, xml_content: String) -> SepaDirectDebitResponse {
