...
pub struct UpdateRolePayload {
    #[serde(rename = "role")]
    pub role: String,
    #[serde(rename = "sync_permissions", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub sync_permissions: Option<Option<bool>>,
}

impl UpdateRolePayload {
    pub fn new(role: String) -> UpdateRolePayload {
        UpdateRolePayload {
            role,
