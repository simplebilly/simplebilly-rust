...
pub struct StilleReport {
    #[serde(rename = "jahresueberschuss")]
    pub jahresueberschuss: String,
    #[serde(rename = "partners")]
    pub partners: Vec<models::StillePartnerZeile>,
    #[serde(rename = "year")]
    pub year: i32,
}

impl StilleReport {
    pub fn new(jahresueberschuss: String, partners: Vec<models::StillePartnerZeile>, year: i32) -> StilleReport {
        StilleReport {
            jahresueberschuss,
            partners,
            year,
