...
**order_date** | Option<**chrono::NaiveDate**> |  | [optional]
**po_number** | Option<**String**> |  | [optional]
**status** | Option<[**models::PurchaseOrderStatus**](PurchaseOrderStatus.md)> | One of: draft | ordered | partially_received | received | cancelled | [optional]
