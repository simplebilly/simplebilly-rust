...
------------ | ------------- | ------------- | -------------
**currency** | Option<**String**> | Currency for the minimum order value. | [optional]
...
**supplier_contact_id** | Option<**String**> | The supplier this condition applies to (`contact_id`). References the supplier entity. | [optional]
