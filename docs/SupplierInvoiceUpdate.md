...
**invoice_date** | Option<**chrono::NaiveDate**> |  | [optional]
**invoice_number** | Option<**String**> |  | [optional]
**line_items** | Option<**serde_json::Value**> | JSON array of `{product_id, name, quantity, unitPriceNet, taxRate}`. | [optional]
**notes** | Option<**String**> |  | [optional]
**purchase_order_id** | Option<**String**> | References the purchase order entity. | [optional]
**status** | Option<[**models::SupplierInvoiceStatus**](SupplierInvoiceStatus.md)> | One of: draft | matched | has_variances | posted | cancelled | [optional]
